...
namespace Abdal_Security_Group_App
{
    public partial class Legal_disclaimer : Telerik.WinControls.UI.RadForm
    {
        ...
        public Legal_disclaimer()
        {
            ...
            Text = abdal_app_name_Legal_disclaimer + " " + version.Major + "." + version.Minor + " - Legal disclaimer";
        }

        private void radButton1_Click(object sender, EventArgs e)
        {
            this.Hide();
            Abdal_Duplicate_Remover main_form = new Abdal_Duplicate_Remover();
            main_form.Show();
        }
        ...
        private void radButton2_Click(object sender, EventArgs e)
        {
            ...
            // string MessageBoxContent = "You do not have the right to use this software, thank you";
            //
            //
